...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/cart/hyperpaycheckout', [PaymentController::class, 'index'])->name('hyperpaycheckout.index');
    Route::post('/checkout/hyperpaycheckout', [PaymentController::class, 'prepareCheckout'])->name('hyperpaycheckout.prepareCheckout');
